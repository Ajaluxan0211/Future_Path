...
const COMPARE = [
  { name: 'Australia',      image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&q=80', minFunds: '$21,041',  ielts: '6.0+', stayPeriod: 'Course length',        popular: false },
  { name: 'Canada',         image: 'https://images.unsplash.com/photo-1517935706615-2717063c2225?w=600&q=80', minFunds: '$10,000+', ielts: '6.0+', stayPeriod: 'Up to 3 yrs post-grad', popular: true  },
  { name: 'United Kingdom', image: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=600&q=80', minFunds: '£12,006+', ielts: '5.5+', stayPeriod: '2 yrs post-grad',        popular: false },
]
...
export default function Visas() {
  ...
  // Preview data — shown muted before search
  ...
  // Use result data if searched, otherwise preview data (muted)
  ...
  return (
    <div style={{ backgroundColor: '#F0F7F4' }} className="min-h-screen pb-16">
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        {/* ── Two column layout — always visible, muted until searched ── */}
        {displayData && (
          <div className="grid grid-cols-5 gap-6 mb-12">

            {/* LEFT — Checklist */}
            <div
              className="col-span-3 bg-white rounded-2xl border p-6 transition-all duration-500"
                ...
                {displayData.docs.map((doc, i) => (
                  <div key={i} className="flex items-start gap-4 py-4 border-b border-gray-100 last:border-0">
                    ...
                    {searched && doc.done ? (
                      ...
                      <div
                        className="w-8 h-8 rounded-full border-2 flex items-center justify-center flex-shrink-0 mt-0.5 transition-all duration-300"
                        style={{
            ...
            <div className="col-span-2">
              ...
              >
                <h3
                  className="text-base font-bold mb-5 transition-colors duration-500"
                  style={{ color: searched ? '#111827' : '#ADB5BD' }}
                >
                  Key details
                </h3>
        ...
        {/* ── Side-by-side comparison — shown after search ── */}
        {searched && (
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-6">Side-by-side comparison</h2>
            <div className="grid grid-cols-3 gap-5">
              {COMPARE.map(c => (
                <div key={c.name} className="bg-white rounded-2xl overflow-hidden"
                  ...
                  <div className="h-44 overflow-hidden mx-3 mt-3 rounded-xl bg-gray-100">
